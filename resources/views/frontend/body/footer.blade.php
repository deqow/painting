    ...
    <div class="container py-5">
        <div class="row g-5">
            <div class="col-lg-3 col-md-6">
                ...
                <p class="mb-4">{{ $allfooter->short_description }}</p>
                <p class="mb-2"><i class="fa fa-map-marker-alt text-primary me-3"></i>{{ $allfooter->adress }}</p>
                <p class="mb-2"><i class="fa fa-envelope text-primary me-3"></i>{{ $allfooter->email }}</p>
                <p class="mb-0"><i class="fa fa-phone-alt text-primary me-3"></i>{{ $allfooter->number }}</p>
            </div>
            <div class="col-lg-3 col-md-6">
            ...
            <div class="col-lg-3 col-md-6">
                ...
                <div class="d-flex">
                    <a class="btn btn-lg btn-primary btn-lg-square rounded-circle me-2" href="{{ $allfooter->twitter }}"><i class="fab fa-twitter"></i></a>
                    <a class="btn btn-lg btn-primary btn-lg-square rounded-circle me-2" href="{{ $allfooter->facebook }}"><i class="fab fa-facebook-f"></i></a>
                    <a class="btn btn-lg btn-primary btn-lg-square rounded-circle" href="{{ $allfooter->instagram }}"><i class="fab fa-instagram"></i></a>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="container">
        <div class="row g-0">
            ...
            <div class="col-md-6 text-center text-md-end">
                <p class="mb-0">Designed by <a class="text-dark fw-bold" href=""> {{ $allfooter->designed_by }}</a></p>
            </div>
        </div>
    </div>
</div>

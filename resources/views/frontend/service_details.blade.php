        ...
        <div class="container py-5">
            <div class="row justify-content-start">
                <div class="col-lg-8 text-center text-lg-start">
                    <h1 class="display-1 text-dark">Service Detail</h1>
                    <div class="pt-2">
                        <a href="" class="btn btn-secondary rounded-pill py-2 px-4 mx-2">Home</a>
                        <a href="" class="btn btn-secondary rounded-pill py-2 px-4 mx-2">Service Detail</a>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="container py-5">
            <div class="row g-3">
                <div class="col-lg-8">
                    ...
                    <div class="mb-5">
                        <img class="img-fluid w-100 mb-5" src="{{ asset($services->service_image) }}" alt="">
                        <h1 class="mb-4">{{$services->service_title}}</h1>
               <b><i class="fa fa-calendar-alt text-secondary mb-2">   {{ Carbon\Carbon::parse($services->created_at)->diffForHumans() }}</i></b>
                ...
                <div class="col-lg-4">
                    ...
                    <div class="mb-5">
                        ...
                        <div class="d-flex flex-column justify-content-start bg-primary p-4">
                            ...
                            <a class="h5 mb-4" href="{{ route('category.service',$category->id) }}"><i class="fa fa-angle-right me-2"></i>{{ $category->service_category }}</a>
                    ...
                    <div class="mb-5">
                        ...
                        <div class="bg-primary p-4">
                            @foreach ($allservices as $recentservice )
                            <div class="d-flex mb-3">
                                <img class="img-fluid" src="{{ asset($recentservice->service_image)  }}" style="width: 100px; height: 100px; object-fit: cover;" alt="">
                                <a href="{{ route('service.details', $recentservice->id) }}" class="h5 d-flex align-items-center bg-white px-3 mb-0">{{ $recentservice->service_title  }}
                                </a>
                            </div>
                            @endforeach

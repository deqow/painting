...
<div class="col-12">
    <div class="card">
        <div class="card-body">
            ...
            <div class="row mb-3">
                <label for="example-text-input" class="col-sm-2 col-form-label">  Designed By</label>
                <div class="col-sm-10">
                    <input name="designed_by" class="form-control" type="text" value="{{ $allfooter->designed_by }}"  id="example-text-input">
                </div>
            </div>
            <!-- end row -->
